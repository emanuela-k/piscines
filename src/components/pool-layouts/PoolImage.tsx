...
const categories: GalleryCategory[] = [
  {
    ...
    images: [
      { src: '/image/image12.jpg', alt: 'Terrasse bois et piscine' },
      { src: '/image/image11.jpg', alt: 'Piscine paysagée haut de gamme' },
      { src: '/image/image1.jpg', alt: 'Piscine avec pergola moderne' },
      { src: '/image/image20.jpg', alt: 'Bassin lumineux de nuit' },
      { src: '/image/image5.jpg', alt: 'Vue d’ensemble du bassin' },
      { src: '/image/image8.jpg', alt: 'Piscine familiale prête à l’usage' },
      { src: '/image/image13.jpg', alt: 'Piscine familiale prête à l’usage' },
      { src: '/image/image14.jpg', alt: 'Piscine familiale prête à l’usage' },
      { src: '/image/image15.jpg', alt: 'Piscine familiale prête à l’usage' },
      { src: '/image/image18.jpg', alt: 'Piscine familiale prête à l’usage' },
      { src: '/image/image19.jpg', alt: 'Piscine familiale prête à l’usage' },
